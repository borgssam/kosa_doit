...
def summarize_txt(file_path: str): # ①
  ...
  system_prompt = f'''
  너는 다음 글을 요약하는 봇이다. 아래 글을 읽고, 저자의 문제 인식과 주장을 파악하고,주요내용을 반드시 한글로 요약하라.
  작성해야 하는 포맷은 다음과 같다.
  # 제목
...
def summarize_pdf(pdf_file_path: str, output_txt_path: str  ):
...
if __name__ == '__main__':
  ...
  output_txt_path = './study/04/output/crop_model_summary.txt'
  summarize_pdf(pdf_file_path, output_txt_path)